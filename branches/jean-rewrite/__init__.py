...
import logging
logger = logging.getLogger('ProjectDatabase')
...
def initialize(context):
    ...
    # profile.
    profile_desc = "Config for ProjectDatabase. Default currency, etc."
    ...
    if CustomizationPolicy and hasattr(CustomizationPolicy, 'register'):
        ...
        print 'Customization policy for ProjectDatabase installed'
