...
def setupState_Machine_2(self, workflow):
    """Define the State_Machine_2 workflow.
    """
                ...
                if prm is not None:
                    try:
                        prm.addRole(role, role, 
                                    "Added by product 'ProjectDatabase'/workflow 'State_Machine_2'")
    ...
    workflow.setProperties(title='State_Machine_2')
    ...
    transitionDef.setProperties(title="""publish""",
                                ...
                                actbox_url="""""",
                                actbox_category="""workflow""",
                                props={'guard_permissions': 'Review portal content', 'guard_roles': 'MilestoneEdit'},
                                )
...
def createState_Machine_2(self, id):
    """Create the workflow for ProjectDatabase.
    """

    ob = DCWorkflowDefinition(id)
    setupState_Machine_2(self, ob)
    return ob

addWorkflowFactory(createState_Machine_2,
                   id='State_Machine_2',
                   title='State_Machine_2')
