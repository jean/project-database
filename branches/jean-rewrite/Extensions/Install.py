...
from Products.ProjectDatabase.config import product_globals as GLOBALS

def install(self, reinstall=False):
    """ External Method to install ProjectDatabase """
    out = StringIO()
    ...
    vocabmap = {'ProjectStatusses': ('VdexVocabulary', 'SimpleVocabularyTerm'),
         ...
         'PARSelfRatings': ('VdexVocabulary', 'SimpleVocabularyTerm'),
    ...
    from Products.ProjectDatabase.config import STYLESHEETS
    try:
        ...
        pass
    from Products.ProjectDatabase.config import JAVASCRIPTS
    try:
