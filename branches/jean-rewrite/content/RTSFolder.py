...
class RTSFolder(BaseFolder):
    ...
    archetype_name = 'RTSFolder'

    meta_type = 'RTSFolder'
    portal_type = 'RTSFolder'
    allowed_content_types = ['RatingTrackingSystem']
    filter_content_types = 1
    global_allow = 0
    #content_icon = 'RTSFolder.gif'
    immediate_view = 'base_view'
    default_view = 'base_view'
    suppl_views = ()
    typeDescription = "RTSFolder"
    typeDescMsgId = 'description_edit_rtsfolder'
