...
# Original workflow id/title: MWorkflow/Milestone Workflow [Plone]
...
def setup_MWorkflow(wf):
    """Setup the workflow
    """
    wf.setProperties(title='Milestone Workflow [Plone]')
    ...
    sdef.setPermission('Access contents information', 1,
                       ['Anonymous', 'Manager', 'Reviewer', 'gef_milestone_edit'])
    sdef.setPermission('Modify portal content', 1,
                       ['Manager', 'Owner', 'gef_milestone_edit'])
    sdef.setPermission('View', 1,
                       ['Anonymous', 'Manager', 'Reviewer', 'gef_milestone_edit'])
    sdef.setPermission('Change portal events', 0,
                       ['Manager', 'Owner', 'gef_milestone_edit'])
    ...
    tdef.setProperties(title='Member makes content private',
                       ...
                       props={'guard_roles': 'gef_milestone_edit'},
                       )
    ...
    tdef.setProperties(title='PO publishes content',
                       ...
                       props={'guard_permissions': 'Review portal content',
                              'guard_roles': 'gef_milestone_edit'},
                       )
...
addWorkflowFactory(create_MWorkflow,
                   id='MWorkflow',
                   title='M Workflow [Plone]')
