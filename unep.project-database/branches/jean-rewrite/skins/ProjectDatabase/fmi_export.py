...
for result in results:
    ...
    for pjimpl_vals in pjimplresults :
      ...
      pjimpl_remark_val = pjimpl_obj.getRemark()
    ...
    for fmi_vals in fmiresults :
      ...
      fcategory_val = fmi_obj.getFinanceCategory()
      pms_number_val = fmi_obj.getPMSNumber()
      imis_number_val = fmi_obj.getIMISNumber()
      total_gef_alloc_val = fmi_obj.getGEFProjectAllocation()
      gef_trust_fund_val = fmi_obj.getGEFTrustFund()
      ldc_fund_allocation_val = fmi_obj.getLDCFundAllocation()
      sccf_allocation_val = fmi_obj.getSCCFAllocation()
      strategic_partnership_val = fmi_obj.getStrategicPartnership()
      adaptation_trust_fund_val =fmi_obj.getAdaptationTrustFund()
      supplementary_unep_allocation_val = fmi_obj.getSupplementaryUNEPAllocation()
      start_date_val = fmi_obj.getStartDate()
      initial_completion_date_val = fmi_obj.getInitialCompletionDate()
      revised_completion_date_val = fmi_obj.getRevisedCompletionDate()
      delay_reason_val = fmi_obj.getDelayReason()
