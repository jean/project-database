...
def setupState_Machine_1(self, workflow):
    """Define the State_Machine_1 workflow.
    """
                ...
                if prm is not None:
                    try:
                        prm.addRole(role, role, 
                                    "Added by product 'ProjectDatabase'/workflow 'State_Machine_1'")
    ...
    workflow.setProperties(title='State_Machine_1')
...
def createState_Machine_1(self, id):
    """Create the workflow for ProjectDatabase.
    """

    ob = DCWorkflowDefinition(id)
    setupState_Machine_1(self, ob)
    return ob

addWorkflowFactory(createState_Machine_1,
                   id='State_Machine_1',
                   title='State_Machine_1')
