...
class Phased(BaseContent, CoreMixin, BlankCoreMixin):
    """
    """
    ...
    global_allow = 0
    #content_icon = 'Phased.gif'
    immediate_view = 'base_view'
    default_view = 'base_view'
    suppl_views = ()
    typeDescription = "Phased"
    typeDescMsgId = 'description_edit_phased'

    _at_rename_after_creation = True

    schema = Phased_schema
...
registerType(Phased, PROJECTNAME)
# end of class Phased
