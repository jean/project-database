...
# Original workflow id/title: gef_project_workflow/Default Workflow [Plone]
...
def setup_ProjectWorkflow(wf):
    """Setup the workflow
    """
    wf.setProperties(title='Project Workflow')
...
def create_ProjectWorkflow(id):
    """Create, setup and return the workflow.
    """
    ob = DCWorkflowDefinition(id)
    setup_ProjectWorkflow(ob)
    return ob

addWorkflowFactory(create_ProjectWorkflow,
                   id='ProjectWorkflow',
