...
# Original workflow id/title: FmiWorkflow/FMI Workflow [Plone]
...
def setup_FmiWorkflow(wf):
    """Setup the workflow
    """
    wf.setProperties(title='FMI Workflow')
...
def create_FmiWorkflow(id):
    """Create, setup and return the workflow.
    """
    ob = DCWorkflowDefinition(id)
    setup_FmiWorkflow(ob)
    return ob

addWorkflowFactory(create_FmiWorkflow,
                   id='FmiWorkflow',
                   title='FMI Workflow')
