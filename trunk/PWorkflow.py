...
# Original workflow id/title: PWorkflow/Default Workflow [Plone]
# Date: 2006/09/18 07:01:58.224 GMT+3
#
...
def setup_PWorkflow(wf):
    ...
    sdef.setPermission('Access contents information', 1,
                       ['Anonymous', 'Manager', 'gef_portfolio_manager'])
    sdef.setPermission('Modify portal content', 0,
                       ['Manager', 'gef_portfolio_manager'])
    sdef.setPermission('View', 1,
                       ['Anonymous', 'Manager', 'gef_portfolio_manager'])
    sdef.setPermission('Change portal events', 0,
                       ['Manager', 'gef_portfolio_manager'])
    ...
    sdef.setPermission('Access contents information', 1,
                       ...
                       'gef_project_edit'])
    sdef.setPermission('Modify portal content', 0,
                       ['Manager', 'Owner', 'gef_portfolio_manager', 'gef_project_edit'])
    sdef.setPermission('View', 1,
                       ['Anonymous',
                       'Manager',
                       'Reviewer',
    ...
    tdef.setProperties(title='Member makes content private',
                       ...
                       props={'guard_roles': 'gef_project_edit'},
                       )
    ...
    tdef.setProperties(title='PO publishes content',
                       ...
                       props={'guard_permissions': 'Review portal content',
                              'guard_roles': 'gef_portfolio_manager'},
                       )
    ...
    ldef.setProperties(description='Reviewer tasks',
                       ...
                       props={'guard_permissions': 'Review portal content',
                              'guard_roles': 'gef_project_edit',
                              'var_match_review_state': 'pending'})

def create_PWorkflow(id):
...
addWorkflowFactory(create_PWorkflow,
                   id='PWorkflow',
